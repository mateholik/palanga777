<?php
/**
 * palanga777 functions and definitions
 *
...
if ( ! function_exists( 'palanga777_setup' ) ) :
	/**
	 ...
	 */
	function palanga777_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on palanga777, use a find and replace
		 * to change 'palanga777' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'palanga777', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'palanga777' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'palanga777_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'palanga777_setup' );
 ...
 */
function palanga777_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'palanga777_content_width', 640 );
}
add_action( 'after_setup_theme', 'palanga777_content_width', 0 );
 ...
 */
function palanga777_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'palanga777' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'palanga777' ),
...
add_action( 'widgets_init', 'palanga777_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function palanga777_scripts() {
	wp_enqueue_style( 'palanga777-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'palanga777-style', 'rtl', 'replace' );

	wp_enqueue_script( 'palanga777-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
